...
$(document).ready(function () {
    ...
    var vm = function () {
        ...
        self.activate = function (id) {
            ...
            var composedUri = `http://192.168.160.58/Olympics/api/Countries?page=${id}&pagesize=20`;
            // var composedUri = `http://192.168.160.58/Olympics/api/Athletes?page=5422&pagesize=25`;
            if (window.location.search.includes("searchCountrie=")) {
                composedUri = `http://192.168.160.58/Olympics/api/Countries/SearchByName?q=${(window.location.search).replace("?searchCountrie=", "")}`
